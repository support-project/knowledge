...
import redcomet.knowledge.dao.gen.GenTagsDao;
...
public class TagsDao extends GenTagsDao {
	...
	public List<TagsEntity> selectOnKnowledgeId(Long knowledgeId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/TagsDao/TagsDao_selectOnKnowledgeId.sql");
	...
	public List<TagsEntity> selectTagsWithCountOnUser(int userid, int offset, int limit) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/TagsDao/TagsDao_selectTagsWithCountOnUser.sql");
