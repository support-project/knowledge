...
public class GenSurveysDao extends AbstractDao {
     ...
     */
    @Aspect(advice = org.support.project.ormapping.transaction.Transaction.class)
    public List<SurveysEntity> physicalSelectAll(Order order) { 
     ...
     */
    @Aspect(advice = org.support.project.ormapping.transaction.Transaction.class)
    public List<SurveysEntity> physicalSelectAllWithPager(int limit, int offset, Order order) { 
     ...
     */
    @Aspect(advice = org.support.project.ormapping.transaction.Transaction.class)
    public List<SurveysEntity> selectAll(Order order) { 
     ...
     */
    @Aspect(advice = org.support.project.ormapping.transaction.Transaction.class)
    public List<SurveysEntity> selectAllWidthPager(int limit, int offset, Order order) { 
