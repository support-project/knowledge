...
public class GenKnowledgeTagsDao extends AbstractDao {
	...
	public List<KnowledgeTagsEntity> physicalSelectAll() { 
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeTagsDao/KnowledgeTagsDao_physical_select_all.sql");
	...
	public KnowledgeTagsEntity physicalSelectOnKey(Long knowledgeId, Integer tagId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeTagsDao/KnowledgeTagsDao_physical_select_on_key.sql");
	...
	public List<KnowledgeTagsEntity> selectAll() { 
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeTagsDao/KnowledgeTagsDao_select_all.sql");
		return executeQuery(sql, KnowledgeTagsEntity.class);
	}
	/**
	 * キーで1件取得 
	...
	public KnowledgeTagsEntity selectOnKey(Long knowledgeId, Integer tagId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeTagsDao/KnowledgeTagsDao_select_on_key.sql");
		return executeQueryOnKey(sql, KnowledgeTagsEntity.class, knowledgeId, tagId);
	}
	/**
	...
	public List<KnowledgeTagsEntity> selectOnKnowledgeId(Long knowledgeId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeTagsDao/KnowledgeTagsDao_select_on_knowledge_id.sql");
	...
	public List<KnowledgeTagsEntity> selectOnTagId(Integer tagId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeTagsDao/KnowledgeTagsDao_select_on_tag_id.sql");
	...
	public List<KnowledgeTagsEntity> physicalSelectOnKnowledgeId(Long knowledgeId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeTagsDao/KnowledgeTagsDao_physical_select_on_knowledge_id.sql");
		return executeQuery(sql, KnowledgeTagsEntity.class, knowledgeId);
	}
	/**
	 * TAG_ID でリストを取得
	...
	public List<KnowledgeTagsEntity> physicalSelectOnTagId(Integer tagId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeTagsDao/KnowledgeTagsDao_physical_select_on_tag_id.sql");
		return executeQuery(sql, KnowledgeTagsEntity.class, tagId);
	}
	/**
	 * 登録(データを生で操作) 
	...
	public KnowledgeTagsEntity physicalInsert(KnowledgeTagsEntity entity) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeTagsDao/KnowledgeTagsDao_insert.sql");
		executeUpdate(sql, 
	...
	public KnowledgeTagsEntity physicalUpdate(KnowledgeTagsEntity entity) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeTagsDao/KnowledgeTagsDao_update.sql");
		executeUpdate(sql, 
			entity.getInsertUser()
			, entity.getInsertDatetime()
			, entity.getUpdateUser()
	...
	public void physicalDelete(Long knowledgeId, Integer tagId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeTagsDao/KnowledgeTagsDao_delete.sql");
