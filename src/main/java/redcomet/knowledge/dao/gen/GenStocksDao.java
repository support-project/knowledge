...
import redcomet.knowledge.entity.StocksEntity;
...
public class GenStocksDao extends AbstractDao {
	...
	public List<StocksEntity> physicalSelectAll() { 
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/StocksDao/StocksDao_physical_select_all.sql");
	...
	public StocksEntity physicalSelectOnKey(Long knowledgeId, Integer userId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/StocksDao/StocksDao_physical_select_on_key.sql");
	...
	public List<StocksEntity> selectAll() { 
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/StocksDao/StocksDao_select_all.sql");
		return executeQuery(sql, StocksEntity.class);
	}
	/**
	 * キーで1件取得 
	...
	public StocksEntity selectOnKey(Long knowledgeId, Integer userId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/StocksDao/StocksDao_select_on_key.sql");
		return executeQueryOnKey(sql, StocksEntity.class, knowledgeId, userId);
	}
	/**
	...
	public List<StocksEntity> selectOnKnowledgeId(Long knowledgeId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/StocksDao/StocksDao_select_on_knowledge_id.sql");
	...
	public List<StocksEntity> selectOnUserId(Integer userId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/StocksDao/StocksDao_select_on_user_id.sql");
	...
	public List<StocksEntity> physicalSelectOnKnowledgeId(Long knowledgeId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/StocksDao/StocksDao_physical_select_on_knowledge_id.sql");
		return executeQuery(sql, StocksEntity.class, knowledgeId);
	}
	/**
	 * USER_ID でリストを取得
	...
	public List<StocksEntity> physicalSelectOnUserId(Integer userId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/StocksDao/StocksDao_physical_select_on_user_id.sql");
		return executeQuery(sql, StocksEntity.class, userId);
	}
	/**
	 * 登録(データを生で操作) 
	...
	public StocksEntity physicalInsert(StocksEntity entity) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/StocksDao/StocksDao_insert.sql");
		executeUpdate(sql, 
			entity.getUserId()
	...
	public StocksEntity physicalUpdate(StocksEntity entity) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/StocksDao/StocksDao_update.sql");
		executeUpdate(sql, 
			entity.getComment()
			, entity.getInsertUser()
			, entity.getInsertDatetime()
	...
	public void physicalDelete(Long knowledgeId, Integer userId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/StocksDao/StocksDao_delete.sql");
