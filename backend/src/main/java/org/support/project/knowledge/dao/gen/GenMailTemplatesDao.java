...
public class GenMailTemplatesDao extends AbstractDao {
     ...
     */
    @Aspect(advice = org.support.project.ormapping.transaction.Transaction.class)
    public List<MailTemplatesEntity> physicalSelectAll(Order order) { 
     ...
     */
    @Aspect(advice = org.support.project.ormapping.transaction.Transaction.class)
    public List<MailTemplatesEntity> physicalSelectAllWithPager(int limit, int offset, Order order) { 
     ...
     */
    @Aspect(advice = org.support.project.ormapping.transaction.Transaction.class)
    public List<MailTemplatesEntity> selectAll(Order order) { 
     ...
     */
    @Aspect(advice = org.support.project.ormapping.transaction.Transaction.class)
    public List<MailTemplatesEntity> selectAllWidthPager(int limit, int offset, Order order) { 
