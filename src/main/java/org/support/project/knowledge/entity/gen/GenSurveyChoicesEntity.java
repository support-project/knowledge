...
public class GenSurveyChoicesEntity implements Serializable {
     ...
     * @return instance
     */
    public static GenSurveyChoicesEntity get() {
        return Container.getComp(GenSurveyChoicesEntity.class);
    }

    /**
     * Constructor.
     */
    public GenSurveyChoicesEntity() {
        super();
    }
    ...
    public GenSurveyChoicesEntity(Integer choiceNo, Integer itemNo, Long knowledgeId) {
        super();
     ...
     * @param knowledgeId ナレッジID
     * @return this object     */
    public GenSurveyChoicesEntity setKnowledgeId(Long knowledgeId) {
        this.knowledgeId = knowledgeId;
        return this;
    }
     ...
     * @param itemNo 項目NO
     * @return this object     */
    public GenSurveyChoicesEntity setItemNo(Integer itemNo) {
        this.itemNo = itemNo;
        return this;
    }
     ...
     * @param choiceNo 選択肢番号
     * @return this object     */
    public GenSurveyChoicesEntity setChoiceNo(Integer choiceNo) {
        this.choiceNo = choiceNo;
        return this;
    }
     ...
     * @return this object     */
    public GenSurveyChoicesEntity setChoiceValue(String choiceValue) {
     ...
     * @return this object     */
    public GenSurveyChoicesEntity setChoiceLabel(String choiceLabel) {
     ...
     * @return this object     */
    public GenSurveyChoicesEntity setInsertUser(Integer insertUser) {
     ...
     * @return this object     */
    public GenSurveyChoicesEntity setInsertDatetime(Timestamp insertDatetime) {
     ...
     * @return this object     */
    public GenSurveyChoicesEntity setUpdateUser(Integer updateUser) {
     ...
     * @return this object     */
    public GenSurveyChoicesEntity setUpdateDatetime(Timestamp updateDatetime) {
     ...
     * @return this object     */
    public GenSurveyChoicesEntity setDeleteFlag(Integer deleteFlag) {
     ...
     * @param knowledgeId ナレッジID
     */
    public void setKeyValues(Integer choiceNo, Integer itemNo, Long knowledgeId) {
        this.choiceNo = choiceNo;
        this.itemNo = itemNo;
        this.knowledgeId = knowledgeId;
    }
     ...
     * @return result 
     */
    public boolean equalsOnKey(GenSurveyChoicesEntity entity) {
