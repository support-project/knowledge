...
public class GenKnowledgeUsersDao extends AbstractDao {
	...
	public List<KnowledgeUsersEntity> physicalSelectAll() { 
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeUsersDao/KnowledgeUsersDao_physical_select_all.sql");
	...
	public KnowledgeUsersEntity physicalSelectOnKey(Long knowledgeId, Integer userId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeUsersDao/KnowledgeUsersDao_physical_select_on_key.sql");
	...
	public List<KnowledgeUsersEntity> selectAll() { 
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeUsersDao/KnowledgeUsersDao_select_all.sql");
		return executeQuery(sql, KnowledgeUsersEntity.class);
	}
	/**
	 * キーで1件取得 
	...
	public KnowledgeUsersEntity selectOnKey(Long knowledgeId, Integer userId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeUsersDao/KnowledgeUsersDao_select_on_key.sql");
		return executeQueryOnKey(sql, KnowledgeUsersEntity.class, knowledgeId, userId);
	}
	/**
	...
	public List<KnowledgeUsersEntity> selectOnKnowledgeId(Long knowledgeId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeUsersDao/KnowledgeUsersDao_select_on_knowledge_id.sql");
	...
	public List<KnowledgeUsersEntity> selectOnUserId(Integer userId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeUsersDao/KnowledgeUsersDao_select_on_user_id.sql");
	...
	public List<KnowledgeUsersEntity> physicalSelectOnKnowledgeId(Long knowledgeId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeUsersDao/KnowledgeUsersDao_physical_select_on_knowledge_id.sql");
		return executeQuery(sql, KnowledgeUsersEntity.class, knowledgeId);
	}
	/**
	 * USER_ID でリストを取得
	...
	public List<KnowledgeUsersEntity> physicalSelectOnUserId(Integer userId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeUsersDao/KnowledgeUsersDao_physical_select_on_user_id.sql");
		return executeQuery(sql, KnowledgeUsersEntity.class, userId);
	}
	/**
	 * 登録(データを生で操作) 
	...
	public KnowledgeUsersEntity physicalInsert(KnowledgeUsersEntity entity) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeUsersDao/KnowledgeUsersDao_insert.sql");
		executeUpdate(sql, 
	...
	public KnowledgeUsersEntity physicalUpdate(KnowledgeUsersEntity entity) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeUsersDao/KnowledgeUsersDao_update.sql");
		executeUpdate(sql, 
			entity.getInsertUser()
			, entity.getInsertDatetime()
			, entity.getUpdateUser()
	...
	public void physicalDelete(Long knowledgeId, Integer userId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/KnowledgeUsersDao/KnowledgeUsersDao_delete.sql");
