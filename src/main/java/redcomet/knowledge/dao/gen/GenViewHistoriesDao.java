...
public class GenViewHistoriesDao extends AbstractDao {
	...
	public ViewHistoriesEntity physicalSelectOnKey(Long historyNo) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/ViewHistoriesDao/ViewHistoriesDao_physical_select_on_key.sql");
	...
	public List<ViewHistoriesEntity> selectAll() { 
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/ViewHistoriesDao/ViewHistoriesDao_select_all.sql");
		return executeQuery(sql, ViewHistoriesEntity.class);
	}
	/**
	 * キーで1件取得 
	...
	public ViewHistoriesEntity selectOnKey(Long historyNo) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/ViewHistoriesDao/ViewHistoriesDao_select_on_key.sql");
		return executeQueryOnKey(sql, ViewHistoriesEntity.class, historyNo);
	}
	/**
	 * 登録(データを生で操作) 
	...
	public ViewHistoriesEntity physicalInsert(ViewHistoriesEntity entity) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/ViewHistoriesDao/ViewHistoriesDao_insert.sql");
	...
	public ViewHistoriesEntity physicalUpdate(ViewHistoriesEntity entity) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/ViewHistoriesDao/ViewHistoriesDao_update.sql");
		executeUpdate(sql, 
			entity.getKnowledgeId()
			, entity.getViewDateTime()
			, entity.getInsertUser()
	...
	public void physicalDelete(Long historyNo) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/ViewHistoriesDao/ViewHistoriesDao_delete.sql");
