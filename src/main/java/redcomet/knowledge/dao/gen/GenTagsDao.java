...
public class GenTagsDao extends AbstractDao {
	...
	public List<TagsEntity> physicalSelectAll() { 
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/TagsDao/TagsDao_physical_select_all.sql");
	...
	public TagsEntity physicalSelectOnKey(Integer tagId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/TagsDao/TagsDao_physical_select_on_key.sql");
	...
	public List<TagsEntity> selectAll() { 
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/TagsDao/TagsDao_select_all.sql");
		return executeQuery(sql, TagsEntity.class);
	}
	/**
	 * キーで1件取得 
	...
	public TagsEntity selectOnKey(Integer tagId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/TagsDao/TagsDao_select_on_key.sql");
		return executeQueryOnKey(sql, TagsEntity.class, tagId);
	}
	/**
	 * 登録(データを生で操作) 
	...
	public TagsEntity physicalInsert(TagsEntity entity) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/TagsDao/TagsDao_insert.sql");
	...
	public TagsEntity physicalUpdate(TagsEntity entity) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/TagsDao/TagsDao_update.sql");
		executeUpdate(sql, 
			entity.getTagName()
			, entity.getInsertUser()
			, entity.getInsertDatetime()
	...
	public void physicalDelete(Integer tagId) {
		String sql = SQLManager.getInstance().getSql("/redcomet/knowledge/dao/sql/TagsDao/TagsDao_delete.sql");
