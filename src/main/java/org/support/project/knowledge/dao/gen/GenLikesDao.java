...
public class GenLikesDao extends AbstractDao {
     ...
     */
    @Aspect(advice = org.support.project.ormapping.transaction.Transaction.class)
    public List<LikesEntity> physicalSelectAll(Order order) { 
     ...
     */
    @Aspect(advice = org.support.project.ormapping.transaction.Transaction.class)
    public List<LikesEntity> physicalSelectAllWithPager(int limit, int offset, Order order) { 
     ...
     */
    @Aspect(advice = org.support.project.ormapping.transaction.Transaction.class)
    public List<LikesEntity> selectAll(Order order) { 
     ...
     */
    @Aspect(advice = org.support.project.ormapping.transaction.Transaction.class)
    public List<LikesEntity> selectAllWidthPager(int limit, int offset, Order order) { 
    ...
    public LikesEntity rawPhysicalInsert(LikesEntity entity) {
        ...
        if (ORMappingParameter.DRIVER_NAME_POSTGRESQL.equals(driverClass)) {
            String maxSql = "SELECT MAX(NO) from LIKES;";
            long max = executeQuerySingle(maxSql, Long.class);
            if (max < 1) {
                max = 1;
            }
            String setValSql = "SELECT SETVAL('LIKES_NO_seq', ?);";
